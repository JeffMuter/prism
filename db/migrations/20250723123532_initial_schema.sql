...
-- Users_locations junction table
...
-- +goose Down
DROP INDEX IF EXISTS idx_eggs_unhached;
DROP INDEX IF EXISTS idx_eggs_user_location;
DROP INDEX IF EXISTS idx_locations_resources_location;
DROP INDEX IF EXISTS idx_workers_tasks_ongoing;
DROP INDEX IF EXISTS idx_workers_tasks_location;
DROP INDEX IF EXISTS idx_workers_tasks_worker;
DROP INDEX IF EXISTS idx_workers_user_location;
DROP INDEX IF EXISTS idx_users_locations_location;
DROP INDEX IF EXISTS idx_users_locations_user;
DROP INDEX IF EXISTS idx_locations_coords;
DROP INDEX IF EXISTS idx_users_email;

DROP TABLE IF EXISTS locations_resources;
DROP TABLE IF EXISTS task_types_resources;
DROP TABLE IF EXISTS location_types_tasks;
DROP TABLE IF EXISTS workers_tasks;
